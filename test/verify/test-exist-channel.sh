...
printCyan "Verifing if the <$TEST_CHANNEL_NAME> channel exists in ${ORG}.${DOMAIN}..."
...
#connectMachine ${ORG}   #last.update->config ?
#result=
echo docker exec cli.${ORG}.${DOMAIN} /bin/bash -c \
