...
printInColor "1;36" "$ORG (Port:$PEER0_PORT) Verifing if the <${CHAINCODE_PREFIX}${TEST_CHANNEL_NAME}>chaincode has been instantiated in the on the <${TEST_CHANNEL_NAME}> channel"
...
printDbg "peer chaincode list --instantiated output for .channel_id: $result";
