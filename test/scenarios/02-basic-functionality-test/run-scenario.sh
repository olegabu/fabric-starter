...
#fi    
    ...
    runStep "Test 'This new channel is not visible in ORG1'" \
        VERIFY:     !test-channel-exists.sh      ${TEST_SECOND_CHANNEL_NAME} ${org1}
...
# Adding orgs to channels
    ...
    runStep "Test 'Add ORG1 to the second channel created by ORG1'" \
