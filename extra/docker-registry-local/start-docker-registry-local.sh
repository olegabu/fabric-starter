...
: ${FABRIC_STARTER_REPOSITORY:-kilpio}
...
dockerImages=(\
    ...
    "nginx" \
    "${FABRIC_STARTER_REPOSITORY:-kilpio}/fabric-starter-rest:${FABRIC_STARTER_VERSION:-stable}" \
    "${FABRIC_STARTER_REPOSITORY:-kilpio}/fabric-tools-extended:${FABRIC_STARTER_VERSION:-stable}"
