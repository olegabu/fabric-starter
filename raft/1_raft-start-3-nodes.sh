...
ORDERER_GENESIS_PROFILE=Raft3OrdererGenesis COMPOSE_PROJECT_NAME=${ORDERER_NAME_PREFIX}0.${DOMAIN} ORDERER_NAME=${ORDERER_NAME_PREFIX}0 WWW_PORT=${WWW_PORT} docker-compose ${DOCKER_COMPOSE_ORDERER_ARGS} up -d orderer cli.orderer www.orderer
sleep 5
