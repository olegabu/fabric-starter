...
COMPOSE_PROJECT_NAME=${ORDERER_NAME}.${ORG}  EXECUTE_BY_ORDERER=1 runCLI "container-scripts/ops/merge-list-into-channel-config.sh ${NEWCONSENTER_NAME} ${NEWCONSENTER_ORG} ${NEWCONSENTER_DOMAIN} ${NEWCONSENTER_PORT}"