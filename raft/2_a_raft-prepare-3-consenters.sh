...
COMPOSE_PROJECT_NAME=${ORDERER_NAME}.${ORDERER_DOMAIN} ORDERER_NAME_PREFIX=${ORDERER_NAME_PREFIX} ORDERER_GENESIS_PROFILE=Raft3OrdererGenesis ORDERER_GENERAL_LISTENPORT=${RAFT0_PORT:-7050} docker-compose ${DOCKER_COMPOSE_ORDERER_ARGS} up -d www.orderer cli.orderer
